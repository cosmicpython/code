...
class TestChangeBatchQuantity:
    ...
    def test_reallocates_if_necessary():
        uow = FakeUnitOfWork()
        handlers.add_batch("b1", "INDIFFERENT-TABLE", 50, None, uow)
        handlers.add_batch("b2", "INDIFFERENT-TABLE", 50, date.today(), uow)
        handlers.allocate("o1", "INDIFFERENT-TABLE", 20, uow)
        handlers.allocate("o2", "INDIFFERENT-TABLE", 20, uow)
